        ...
        <main class="max-w-7xl mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                <form id="filterForm" class="flex flex-wrap gap-4">
                    <select name="category" id="categoryFilter" class="flex-1 border rounded-lg px-4 py-2">
                    ...
                    <input type="number" name="max_price" id="maxPriceFilter"
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('filterForm').addEventListener('submit', function(e) {
                    ...
                    fetch(`../controller/user_dashboard.php?ajax=true&${params}`)
                        .then(response => response.json())
                        .then(data => {
                            updateCarListings(data.cars);
            ...
            function updateCarListings(cars) {
                ...
                cars.forEach(car => {
                    ...
                    title.textContent = `${car.marque} ${car.modele}`;
                    cardBody.appendChild(title);

                    const details = document.createElement('div');
                    details.className = 'text-gray-600 mb-4';
                    details.innerHTML = `
            <p><i class="fas fa-tag mr-2"></i>€${parseFloat(car.prix).toFixed(2)} per day</p>
            <p><i class="fas fa-car mr-2"></i>${car.category_name}</p>
            <p><i class="fas fa-users mr-2"></i>${car.places} seats</p>
        `;
                    ...
                    button.onclick = () => showReservationModal(car);
            ...
            function updatePagination(currentPage, totalPages) {
                ...
                if (currentPage > 1) {
                    ...
                    prevLink.className = 'px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300';
                ...
                for (let i = 1; i <= totalPages; i++) {
                    ...
                    pageLink.className = `px-4 py-2 ${i === currentPage ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'} rounded-lg hover:bg-blue-600 hover:text-white`;
                ...
                if (currentPage < totalPages) {
                    ...
                    nextLink.className = 'px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300';
